...
async function depositDAI(signer, amount ) {
	...
	let depositDAI = dexcontract.connect(signer);
	let tx = await depositDAI.depositDAI(
		// amount dalna hai yahan DAIdepositDAI kitna manga
        amount
	);
