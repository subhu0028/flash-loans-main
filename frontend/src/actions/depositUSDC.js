...
async function depositUSDC(signer, amount) {
	...
	let depositUSDC = dexcontract.connect(signer);
	let tx = await depositUSDC.depositUSDC(
		// amount dalna hai yahan usdc kitna manga
        amount
	);
